...
import { useMyTenantHistory } from '../hooks/useMyTenantHistory';
import type { TenantHistoryEntry } from '../../tenants/types/tenant';
  ...
  return (
    <>
      ...
      >
        ...
        <TableCell>
          <Typography variant="body2" color="text.secondary">{changeSummary(entry)}</Typography>
        </TableCell>
        <TableCell>
...
export function MyCompanyHistoryTable() {
    ...
    <Box>
      ...
      {isError && (
        <Alert severity="error">
          {getApiErrorMessage(error, 'Failed to load history. Please try again.')}
        </Alert>
      )}
      ...
      {!isLoading && !isError && entries.length === 0 && (
        <Box sx={{ py: 6, textAlign: 'center' }}>
          ...
          <Typography variant="body2" color="text.secondary">
            Changes to your company will show up here.
          </Typography>
        </Box>
      )}
